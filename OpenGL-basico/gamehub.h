...
class gamehub
{
	...
	rectangulo minutos_decena_ = rectangulo(vector3(-215,600, 0.0f), vector3(-115, 600, 0.0f), vector3(-115, 450, 0.0f), vector3(-215, 450, 0.0f));
	rectangulo minutos_unidades_ = rectangulo(vector3(-115, 600, 0.0f), vector3(-15, 600, 0.0f), vector3(-15, 450, 0.0f), vector3(-115, 450, 0.0f));
	...
	rectangulo segundos_decena_ = rectangulo(vector3(15,600, 0.0f), vector3( 115 , 600, 0.0f), vector3(115, 450, 0.0f), vector3(15, 450, 0.0f));
	rectangulo segundos_unidades_ = rectangulo(vector3(115, 600, 0.0f), vector3(215, 600, 0.0f), vector3(215, 450, 0.0f), vector3(115, 450, 0.0f));
